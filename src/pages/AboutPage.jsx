    ...
    return (
        ...
        <div className="bg-[#fdf5e6] min-h-screen font-sans">
            ...
            <div className="bg-[#2d3e50] text-white text-center py-[70px] px-5">
                <h1 className="text-[38px] font-bold mb-[15px]">{t('about.title', 'Về DANAEventSpark')}</h1>
                <p className="text-base opacity-85 tracking-[0.5px]">{t('about.tagline', 'Kết nối cộng đồng qua từng khoảnh khắc ý nghĩa')}</p>
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-[50px] items-start">
                    ...
                    <div className="flex-[1.2] w-full">
                        ...
                        <p className="text-[#4a5568] text-base leading-relaxed mb-5 text-justify">
                            {t('about.mission_desc_1', 'EventSpark được ra đời với mong muốn tạo ra một không gian kết nối cộng đồng hiện đại, nơi mọi người có thể dễ dàng tìm kiếm và tham gia vào những hoạt động ý nghĩa xung quanh mình.')}
                        </p>
                        
                        <p className="text-[#4a5568] text-base leading-relaxed mb-5 text-justify">
                            {t('about.mission_desc_2', 'Chúng tôi tin rằng mỗi sự kiện, dù lớn hay nhỏ, đều mang trong mình sức mạnh gắn kết và tạo nên những thay đổi tích cực cho xã hội.')}
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-[35px]">
                            ...
                            <div className="bg-white border border-[#e2e8f0] rounded-[16px] p-5 shadow-[0_4px_10px_rgba(0,0,0,0.02)]">
                                ...
                                <h3 className="text-[#2d3e50] text-lg font-bold mb-2">{t('about.connection_title', 'Kết nối')}</h3>
                                <p className="text-[#718096] text-sm leading-normal">{t('about.connection_desc', 'Gắn kết mọi người qua những sở thích chung.')}</p>
                            </div>

                            {/* Thẻ Sáng tạo */}
                            <div className="bg-white border border-[#e2e8f0] rounded-[16px] p-5 shadow-[0_4px_10px_rgba(0,0,0,0.02)]">
                                <div className="text-2xl mb-2.5">☀️</div>
                                <h3 className="text-[#2d3e50] text-lg font-bold mb-2">{t('about.creativity_title', 'Sáng tạo')}</h3>
                                <p className="text-[#718096] text-sm leading-normal">{t('about.creativity_desc', 'Không ngừng đổi mới trải nghiệm người dùng.')}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-[0.8] w-full">
                        <img 
                            ...
                            alt={t('about.community_alt', 'Cộng đồng EventSpark')} 
