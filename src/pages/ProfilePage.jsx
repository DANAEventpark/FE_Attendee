          ...
          <div className="w-full md:w-64 bg-gray-50/50 border-r border-gray-100 p-6 flex flex-col gap-2">
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left font-medium transition-colors ${
                activeTab === 'info' ? 'bg-[#E53E3E] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <User size={20} />
              Thông tin chung
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left font-medium transition-colors ${
                activeTab === 'password' ? 'bg-[#E53E3E] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
              <Lock size={20} />
              Đổi mật khẩu
            ...
            {activeTab === 'info' && (
              <form onSubmit={handleUpdateInfo} className="max-w-xl">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 bg-white rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#E53E3E] focus:border-transparent outline-none transition-colors"
                    />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="mt-8 flex items-center gap-2 bg-gray-900 hover:bg-black text-white px-6 py-3 rounded-xl font-medium transition-colors disabled:opacity-70"
                >
